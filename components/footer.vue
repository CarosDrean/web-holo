          ...
          <div class="col-lg col-md-6">
            <div class="ftco-footer-widget">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="espirometria"><span class="fa fa-chevron-right mr-2"></span>Espirometría</a></li>
                <li><a href="rayosx"><span class="fa fa-chevron-right mr-2"></span>Rayos X</a></li>
                <li><a href="audiometria"><span class="fa fa-chevron-right mr-2"></span>Audiometría</a></li>
                <li><a href="psicologia"><span class="fa fa-chevron-right mr-2"></span>Psicología</a></li>
          ...
          <div class="col-lg col-md-6">
            <div class="ftco-footer-widget">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="about"><span class="fa fa-chevron-right mr-2"></span>Conocenos</a></li>
                <li><a href="services"><span class="fa fa-chevron-right mr-2"></span>Servicios</a></li>
                <li><a href="doctors"><span class="fa fa-chevron-right mr-2"></span>Doctores</a></li>
                <!-- <li><a href="blog"><span class="fa fa-chevron-right mr-2"></span>Blog</a></li> -->
                 <li><a href="price"><span class="fa fa-chevron-right mr-2"></span>Cotizaciones</a></li>
                 <li><a href="contact"><span class="fa fa-chevron-right mr-2"></span>Contáctenos</a></li>
               </ul>
             </div>
           </div>
           ...
           <div class="col-lg col-md-6">
             <div class="ftco-footer-widget">
               ...
               <ul class="list-unstyled">
                 <li><a href="http://manuelhuaman.com/"><span class="fa fa-chevron-right mr-2"></span>Cardiología</a></li>
                 <li><a href="doctors"><span class="fa fa-chevron-right mr-2"></span>Staff Médico</a></li>
                 <li><a href="contact"><span class="fa fa-chevron-right mr-2"></span>Ubícanos</a></li>
             ...
             <div class="ftco-footer-widget">
               ...
               <div class="block-23 mb-3">
                 <ul>
                   ...
                   <li><a href="https://api.whatsapp.com/send?phone=51943991985&text=Hola%20CL%C3%8DNICA%20HOLOSALUD%20quisiera%20informacion%0Ahttps%3A%2F%2Fwww.holosalud.pe%2Fweb"><span class="fa fa-phone mr-3"></span><span class="text">943991985</span></a></li>
                   <li><a href="https://mail.google.com/"><span class="fa fa-paper-plane mr-3"></span><span class="text">saludocupacional@holosalud.pe</span></a></li>
                 </ul>
               </div>
             </div>
           </div>
